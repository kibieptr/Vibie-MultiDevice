...
let handler = async (m, { text, usedPrefix, command }) => {
  try {
    ...
    let teks = `- Khodam \`@${
      m.quoted ? m.quoted.sender.split("@")[0] : m.sender.split("@")[0]
...
async function khodamnya() {
  const khodams = [
    ...
    },
    {
      name: "Kucing Kulkas",
      meaning:
        "Kamu misterius dan selalu ada di tempat-tempat yang tak terduga.",
    },
    {
      name: "Sabun Wangi",
      meaning:
    ...
    },
    {
      name: "Ikan Terbang",
      meaning:
        "Kamu unik dan penuh kejutan, selalu melampaui batasan yang ada.",
    },
    {
      name: "Ayam Goreng",
      meaning:
    ...
    },
    {
      name: "Sapu Lidi",
      meaning:
        "Kamu kuat dan selalu bisa diandalkan untuk membersihkan masalah.",
    },
    {
      name: "Kuda Lumping",
      meaning:
        "Kamu penuh semangat dan selalu tampil beda di setiap kesempatan.",
    },
    {
      name: "Sepatu Roda",
      meaning:
    ...
    },
    {
      name: "Kucing Gemuk",
      meaning:
        "Kamu santai dan selalu bikin orang tersenyum dengan kelucuanmu.",
    },
    {
      name: "Iguana Pink",
      meaning:
    ...
    },
    {
      name: "Nasi Padang",
      meaning:
        "Kamu selalu bikin kenyang dan puas dengan kelezatanmu yang khas.",
    },
    {
      name: "Roti Bakar",
    ...
    },
    {
      name: "Telur Dadar",
      meaning:
        "Kamu sederhana tapi selalu bikin orang puas dengan kelezatanmu.",
    },
    {
      name: "Es Buah",
      meaning:
        "Kamu segar dan penuh warna, selalu bikin hari jadi lebih ceria.",
    },
    {
      name: "Mie Goreng",
    ...
    },
    {
      name: "Tahu Bulat",
      meaning:
        "Kamu selalu hadir di momen-momen yang pas dengan rasa yang enak.",
    },
    {
    ...
    {
      name: "Handphone Jadul",
      meaning: "Selalu setia meski ketinggalan zaman",
    },
    ...
    {
      name: "Gitar Sumbang",
      meaning: "Selalu memberikan nada yang tak terduga",
    },
    ...
    {
      name: "Piring Berjalan",
      meaning: "Tak pernah tinggal diam di tempatnya",
    },
    {
      name: "Ember Tertawa",
    ...
    },
    {
      ...
      meaning:
        "Terlihat malas-malasan tapi selalu memberikan cahaya yang hangat",
    },
    {
    ...
    {
      name: "Cermin Menggigil",
      meaning: "Selalu memberikan pantulan yang lucu",
    },
    {
    ...
    {
      name: "Topi Tertawa",
      meaning: "Terlihat ceria di atas kepala siapa pun",
    },
    {
    ...
    {
      name: "Panci Pintar",
      meaning: "Selalu memberikan masakan yang sempurna",
    },
